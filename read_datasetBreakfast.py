...
def load_data(split_load, actions_dict, GT_folder, DATA_folder, datatype = 'training',):
    ...
    if datatype == 'training':
        data_breakfast_file_ptr = open(f'training_data.dat', 'wb')
        ...
        for content in content_all:
            ...
            pickle.dump((torch.tensor(curr_data, dtype=torch.float64 ), label_curr_video), data_breakfast_file_ptr)

            count += 1
            print(f'{count} {content} contents dumped')
